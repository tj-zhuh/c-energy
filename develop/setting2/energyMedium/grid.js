...
define(function (require) {
    ...
    var storeConfig = {
        fields: ['ROWNUM', 'ENTERPRISEENERGYID', 'EMEDIUMID', 'ENERGYDESC', 'ENTERPRISEID', 'ENTERPRISENAME', 'UNITID', 'UNITCODE', 'UNITDESC', 'BUSINESSID', 'BUSINESSNAME', 'PROVINCEID', 'PROVINCENAME']
    }
