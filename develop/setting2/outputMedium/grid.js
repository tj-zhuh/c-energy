...
define(function (require) {
    ...
    var storeConfig = {
        fields: ['ROWNUM', 'ENEMISSIONID', 'ENTERPRISEID', 'EEMISSIONID', 'EMISSIONTYPE', 'EEMISSIONCODE', 'EEMISSIONDESC', 'UNITID', 'ENTERPRISENAME', 'EMISSIONDESC', 'EMISSIONCODE', 'UNITCODE', 'UNITDESC']
    }
    ...
    var gridConfig = {
        columns: {
            ...
            items: [{
                ...
                text: '排放源名称',
                dataIndex: 'EEMISSIONDESC'
            }, {
                text: '排放源编码',
                dataIndex: 'EEMISSIONCODE'
            }, {
                text: '排放源类型',
