...
define(function (require) {
    ...
    $(function () {
        ...
        // 预加载图片
        util.preload('/images/btn-delete-hover.png', '/images/btn-delete-active.png',
            '/images/btn-edit-hover.png', '/images/btn-edit-active.png');
        ...
        Ext.onReady(function () {
            ...
            grid.delete(function (id) {
                dao.delete({ UNITID: id }, function (result) {
                    util.alert('删除成功');
                    query();
                })
            });
