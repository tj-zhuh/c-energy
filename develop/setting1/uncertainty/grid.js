...
define(function (require) {
    ...
    var storeConfig = {
        fields: ['index', 'calculateId', 'calculateFunc', 'maxBurning', 'minBurning', 'maxGray','minGray','unCertainty']
    }
    ...
    var gridConfig = {
        columns: {
            ...
            items: [{
                ...
                text: '测量方法',
                dataIndex: 'calculateFunc'
            }, {
                text: '燃值最大',
                dataIndex: 'maxBurning'
            }, {
                text: '燃值最小',
                dataIndex: 'minBurning'
            }, {
                text: '灰份最大',
                dataIndex: 'maxGray'
            }, {
