...
define(function (require) {
    ...
    var storeConfig = {
        fields: ['ROWNUM', 'EFACTORID', 'BUSINESSID', 'BUSINESSNAME', 'EMEDIUMID', 'ENERGYDESC', 'EMISSIONTYPESOURCE', 'FACTORVALUE', 'UNITID', 'UNITDESC','FACTORGBCODE' ]
    }
    ...
    ret.init = function () {
        ...
        $('.grid-container').on('click', '.btn-delete', function (e) {
            ...
            var id = record.EFACTORID;
            var name = record.ENERGYDESC;
