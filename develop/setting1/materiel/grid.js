...
define(function (require) {
    ...
    var storeConfig = {
        fields: ['ROWNUM', 'BUSINESSNAME', 'MATERIALDESC', 'UNITDESC', 'UNITCODE', 'CATEGORYDESC', 'BUSINESSID', 'BMATERIALID', 'UNITID', 'MCATEGORYID']
    }
    ...
    ret.init = function () {
        ...
        $('.grid-container').on('click', '.btn-delete', function (e) {
            ...
            console.log(record)
            var id = record.BMATERIALID;
            var name = record.MATERIALDESC;
            if (util.confirm('确认要删除名为' + name + '的条目吗？')) {
