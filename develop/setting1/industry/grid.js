...
define(function (require) {
    ...
    var storeConfig = {
        fields: ['ROWNUM', 'BUSINESSNAME', 'BUSINESSCODE', 'BUSINESSID','ISCOLLECTED']
    }
    ...
    var gridConfig = {
        columns: {
            ...
            items: [{
                ...
                text: '操作',
                renderer: function () {
                    return "<div class='image-buttons'><div class='btn-delete' style='display:none; '></div><div class='btn-edit'></div></div>";
                }
            }]
        },
    ...
    ret.init = function () {
        ...
        $('.grid-container').on('click', '.btn-delete', function (e) {
            ...
            var id = record.BUSINESSID;
            var name = record.BUSINESSNAME;
