...
define(function (require) {
    ...
    var storeConfig = {
        fields: ['ROWNUM', 'EMISSIONTYPEID','BUSINESSID','BUSINESSNAME', 'ETYPECODE', 'EMISSIONTYPEDESC', 'EMISSIONTYPESOURCE' ]
    }
    ...
    ret.init = function () {
        ...
        $('.grid-container').on('click', '.btn-delete', function (e) {
            ...
            var id = record.EMISSIONTYPEID;
            var name = record.EMISSIONTYPEDESC;
