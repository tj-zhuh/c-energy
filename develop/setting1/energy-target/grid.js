...
define(function (require) {
    ...
    var storeConfig = {
        fields: ['ROWNUM', 'ESAVINGINDEXID', 'BUSINESSID', 'BUSINESSNAME', 'PROVINCEID', 'PROVINCENAME', 'ENTERPRISEID', 'ENTERPRISENAME', 'ENERGYYEAR', 'SAVINGVALUE', 'UNITID', 'UNITCODE', 'UNITDESC' ]
    }
    ...
    ret.init = function () {
        ...
        $('.grid-container').on('click', '.btn-delete', function (e) {
            ...
            var id = record.ESAVINGINDEXID;
            var name = record.SAVINGVALUE;
