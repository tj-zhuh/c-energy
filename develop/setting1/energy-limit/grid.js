...
define(function (require) {
    ...
    var storeConfig = {
        fields: ['ROWNUM', 'INDEXNAME', 'BUSINESSID', 'BUSINESSNAME', 'LIMTTYPE', 'LIMITVALUE', 'STANDARDTYPE', 'UNITDESC', 'EINDEXID', 'ELIMITID', 'UNITID', 'UNITCODE', 'LIMITMATNAME']
    }
    ...
    ret.init = function () {
        ...
        $('.grid-container').on('click', '.btn-delete', function (e) {
            ...
            var id = record.ELIMITID;
            var name = record.INDEXNAME;
