...
define(function (require) {
    ...
    var storeConfig = {
        fields: ['ROWNUM', 'TARGETVALUEID', 'BUSINESSID', 'BUSINESSNAME', 'PROVINCEID', 'PROVINCENAME', 'ENTERPRISEID', 'ENTERPRISENAME', 'CHECKYEAR', 'CTARGETVALUE', 'UNITID', 'UNITCODE', 'UNITDESC', 'CTYPE']
    }
    ...
    var gridConfig = {
        columns: {
            ...
            items: [{
                ...
                text: '指标值',
                dataIndex: 'CTARGETVALUE'
            }, {
                text: '单位',
                dataIndex: 'UNITDESC',
                renderer: function (a, b) {
                    return a + "(" + b.record.data.UNITCODE + ")";
                }
            }, {
                text: '类型',
                dataIndex: 'CTYPE',
    ...
    ret.init = function () {
        ...
        $('.grid-container').on('click', '.btn-delete', function (e) {
            ...
            var id = record.TARGETVALUEID;
            var name = record.CTARGETVALUE;
            util.confirm('确认要删除值为' + name + '的条目吗？', function () {
