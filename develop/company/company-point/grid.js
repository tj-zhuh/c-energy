...
define(function (require) {
    ...
    var storeConfig = {
        fields: ['POINTID', 'POINTDESC', 'POINTCODE', 'DATAVALUE', 'CHECKDATE', 'UNITCODE']
    }
    ...
    ret.init = function () {
        ...
        // 设置容器
        gridConfig.renderTo = Ext.get('grid-panel');
    ...
    ret.loadData = function (data) {
        ...
        if (data.list >= this.ps) {
            $('#grid-panel').addClass('full');
        } else {
            $('#grid-panel').removeClass('full');
        }
