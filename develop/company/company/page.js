...
define(function (require) {
	...
	var chart11 = require('chart11');
	var chart12 = require('chart12');
	...
	$(function () {
		...
		$('#history').click(function () {
		    ...
		    $("#consumeC").removeClass("active");
		    dao.getHistory11LineData(getCondition().queryCondition, function (data) {
		        if (data) {
		            if (data.list != null && data.list != undefined)
		            { chart11.draw(data.list); }
		        }
		    })
		    dao.getHistory12LineData(getCondition().queryCondition, function (data) {
		        if (data) {
		            if (data.list != null && data.list != undefined)
		            { chart12.draw(data.list); }
		        }
		    })
		})
