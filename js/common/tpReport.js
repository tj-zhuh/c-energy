...
var dst = (function () {
    ...
    function checkPrePost(type, year, month, day) {
        var now = nowYMD();
        var start = { y: conf.startYear, m: conf.startMonth, d: conf.startDay };
    ...
    ret.init = function () {
        var type = conf.type;
        var _startYear = conf.startYear;
        var _startMonth = conf.startMonth;
        var _startDay = conf.startDay;
...
var demoHelper = (function () {
    ...
    ret.line = function () {
        ...
        if (options.multiCvs) {
            ...
            ss.push({ name: '环比', min: -50, max: 50, yAxisIndex: 1, lineType: 'dashed', step: true });
