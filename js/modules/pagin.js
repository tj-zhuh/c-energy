; (function (root, factory) {
    ...
    function ctor() {
        ...
        this.paginList = null; // paginList元素
        this.changeHandler;  // 页码变化的处理函数
    ...
    ctor.prototype.init = function () {
        ...
        // 创建paginList
        var paginList = $("<div class='paginList'></div>");
        this.el.append(paginList);
        this.paginList = paginList;
    }

    // 设置页码
    ctor.prototype.set = function (ps, total) {
        var that = this;

        this.paginList.pagination({
            ...
            callback: function (data, pagination) {
                var pageId = pagination.pageNumber;
                if (pagination.direction) {
                    that.changeHandler(pageId, ps * (pageId - 1), ps, total);
                }
            },
