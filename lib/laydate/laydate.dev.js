...
win.laydatetime = function () {   
    return win.laydate({ istime: true, ismonth:false, format: 'YYYY-MM-DD hh:mm:ss' })
}

win.laymonth = function () {    
    return win.laydate({ istime: false, ismonth: true, format: 'YYYY-MM' })
}
...
Dates.view = function(elem, options){
    ...
    var olddiv = document.getElementById(as[0]);
    if (olddiv) {
    ...
    if (!Dates.box) {
        ...
        +'<div class="laydate_bottom">'
          ...
          +'<div class="laydate_btn">'
            ...
            +'<a id="laydate_today">'+ today_str +'</a>'
